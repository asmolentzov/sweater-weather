  ...
  days.forEach(day => {
    $('.daily-container').append(`
      <div class="day">
        ...
        <div class="daily-summary daily-icon"><i class="fas fa-sun"></i>${day.summary}</div>
        <div class="daily-precip daily-icon"><i class="fas fa-tint"></i>${day.precipProbability}%</div>
        <div class="daily-high"><i class="fas fa-long-arrow-alt-up"></i>${day.tempHigh}\xB0F</div>
        <div class="daily-low"><i class="fas fa-long-arrow-alt-down"></i>${day.tempLow}\xB0F</div>
      </div>`)
  })
};
