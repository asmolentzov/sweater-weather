...
const setCurrentWeather = (weatherInfo) => {
  ...
  $('#details-summary').text(currentWeather.detailsSummary);
  $('#details-feels').text(currentWeather.tempFeelsLike);
  $('#details-humidity').text(currentWeather.humidity);
  $('#details-visibility').text(currentWeather.visibility);
  $('#details-uv').text(currentWeather.uv);
};
